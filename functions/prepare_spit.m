...
%   --------------------------------------------------------------------
    ...
    SPIT.Dsf=S.d*0.8;                                                                     % underwater part of active height for shoreface -> used only in spit-width function
    SPIT.Dbb=1*SPIT.Dsf;                                                                  % underwater part of active height for back-barrier -> used only in spit-width function
