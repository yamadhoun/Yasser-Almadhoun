function [Hsout]=introduce_perm_structures(STRUC,WAVE,COAST)
...
% 
% OUTPUT:
%   HStdp               Transmitted significant wave height at considered time instance (m)
%
%% Copyright notice
%   --------------------------------------------------------------------
...
%   --------------------------------------------------------------------
    ...
    if STRUC.perm
        ...
        for i_mc=1:n_mc
            ...
            [ ~,~,shadowP ] = find_shadows(COAST.x,COAST.y,x_p,y_p,WAVE.phiwi,1,WAVE.phiwi,1);
